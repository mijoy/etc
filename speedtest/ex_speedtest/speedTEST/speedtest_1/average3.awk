...

{
    ...
    #    totalsize += x
    indexI1_1 = x
    mean1_1   = mean0_1 +1/count_1 * ( x - mean0_1 )
    sd1_1     = sd0_1 + ( x - mean0_1 )*( x - mean1_1 )
    mean0_1   = mean1_1
    sd0_1     = sd1_1
    if (count_1 !=0 && sd0_1 != 0) {
    sample_deviation_1   = sqrt(1/(count_1-1)*sd0_1)
    standard_deviation_1 = sqrt(1/count_1*sd0_1)
    }
}
